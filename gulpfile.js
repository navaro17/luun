...
function clean(done) {
  del([(dir.build + 'styles/'), (dir.build + 'js/')])
  done()
}
exports.clean = clean
...
function buildJekyllOne() {
  const shellCommand = 'bundle exec jekyll build --config _config.yml,_config_local.yml'
  return gulp
    .src('.', { allowEmpty: true })
...
exports.prod = gulp.series(exports.clean, exports.css, exports.scripts, images, buildJekyllTwo)
